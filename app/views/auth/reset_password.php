...
<head>
    <meta charset="UTF-8">
    <title>Reset Password - Visit Mindoro</title>
    ...
    <div class="relative flex min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-800">
        ...
        <div class="relative z-10 w-full max-w-md space-y-8 bg-white/90 backdrop-blur-sm shadow-2xl rounded-2xl p-8 sm:p-10 animate-fade-in">
            ...
            <form class="mt-8 space-y-6" action="<?= site_url('auth/process-reset-password') ?>" method="POST">
                ...
                <div>
                    <label for="password_confirm" class="block text-sm font-medium leading-6 text-gray-900">Confirm New Password</label>
                    <div class="mt-2 relative">
            ...
            <p class="mt-10 text-center text-sm text-gray-700">
                <a href="<?= site_url('login') ?>" class="font-medium text-orange-600 hover:text-orange-500">&larr; Back to login</a>
            </p>
        </div>
    </div>
