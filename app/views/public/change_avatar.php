...
<head>
    <meta charset="UTF-8">
    <title>Change Avatar - Visit Mindoro</title>
               ...
               <div class="hidden md:flex md:items-center md:space-x-4">
                   ...
                   ?>
                       <div class="ml-4 flex items-center space-x-4">
                            <a href="<?= site_url('my-profile') ?>" class="flex items-center text-sm font-semibold text-orange-600">
    ...
    <div class="max-w-xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div class="bg-white shadow sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Upload a new avatar (JPG, PNG, GIF, max 2MB).</p>
                ...
                <div class="mt-5">
                    <form action="<?= site_url('profile/upload-avatar') ?>" method="post" enctype="multipart/form-data">
                        <div>
                            <label for="avatar" class="block text-sm font-medium text-gray-700">Select Image</label>
                            <input type="file" name="avatar" id="avatar" required accept="image/png, image/jpeg, image/gif" class="mt-1 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100">
                        </div>

                        <div class="mt-6 flex items-center justify-end gap-x-6">
                            <a href="<?= site_url('my-profile') ?>" class="text-sm font-semibold leading-6 text-gray-900">Cancel</a>
                            <button type="submit" class="inline-flex justify-center rounded-md border border-transparent bg-orange-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-orange-700">Upload Avatar</button>
                        </div>
                    </form>
                </div>
            </div>
