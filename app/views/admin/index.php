...
<body class="bg-gray-100">
    <div class="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div class="mb-8 pb-4 border-b border-gray-300">
            ...
            <h1 class="mt-4 text-3xl font-bold text-gray-800">Manage Tours</h1>
        </div>
        <div class="bg-white shadow sm:rounded-lg overflow-hidden">
            <div class="px-4 py-5 sm:p-6">
                <div class="sm:flex sm:items-center sm:justify-between mb-6">
                    <p class="text-sm text-gray-600">A list of all tour packages in the system.</p>
                    <div class="mt-3 sm:mt-0 sm:ml-4">
                        <a href="<?= site_url('admin/add') ?>" class="inline-flex items-center justify-center rounded-md border border-transparent bg-orange-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-orange-700">
                            Add New Tour
                        </a>
                    </div>
                </div>
                            ...
                            <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-300">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">Tour Name</th>
                                    ...
                                    <tbody class="divide-y divide-gray-200 bg-white">
                                        <?php foreach ($tours as $tour): ?>
                                            <tr>
                                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-6"><?= html_escape($tour['name']); ?></td>
                                                <td class="whitespace-normal px-3 py-4 text-sm text-gray-500 max-w-xs truncate"><?= html_escape($tour['description']); ?></td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">₱<?= number_format($tour['price'], 2); ?></td>
